<template>
    <div class="row bottom-nav">
        ...
        <div v-if="this.currentCourse == null || this.flashroster.length == 0" v-bind:class="{[selected]: this.currentLocation == 'class'}" id="students" class="col-xs-3 type--center bottom-nav__button--disabled">
