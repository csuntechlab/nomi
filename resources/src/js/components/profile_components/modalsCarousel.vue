  ...
  <div class="modal-body__carousel">
    <carousel v-if="okayToUpdate" :perPage="1" :paginationActiveColor="'#919191'" :paginationColor="'rgba(145,145,145,.3)'" @pageChange="handleSlideClick">
        <slide class="slide-wrap">
          <div>
            <profile-picture v-show="!switchItUp" :image="likenessImage" :editable="false" :type="'profile-picture'" :student="student"></profile-picture>
        ...
        <slide class="slide-wrap">
          <div>
              <profile-picture :image="avatarImage" :editable="false" :type="'profile-picture'" :student="student"></profile-picture>
              <div class="type--center">
