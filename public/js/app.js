...
Vue.component('list-grid-selector', __webpack_require__(144));
...
Vue.component('home-settings-banner', __webpack_require__(149));
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "banner__position bg--navy-blue" },
    [
      ...
      _c(
        "router-link",
        { staticClass: "type--left light-grey", attrs: { to: "/" } },
        [_vm._v("Back")]
      )
    ],
    1
