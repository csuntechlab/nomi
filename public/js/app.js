            ...
            [
              _c("img", {
                attrs: {
                  ...
                  src: this.student.images.likeness_image
                },
                slot: "initial"
              })
            ]
            ...
            _c("slide", { staticClass: "slide-wrap" }, [
              _c(
                ...
                [
                  _c("profile-picture", {
                    attrs: {
                      image: _vm.student.images.avatar_image,
                      editable: false,
                      type: "profile"
                    }
                  }),
                  ...
                  _c(
                    ...
                    [
                      _c("profile-picture", {
                        attrs: {
                          student: _vm.student,
                          image: _vm.student.images.likeness_image,
                          editable: true,
                          type: "profile"
                        }
                      }),
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getStudentProfile: function getStudentProfile(context, payload) {
        ...
        window.axios.get('student_profile/' + email).then(function (payload) {
            ...
            window.axios.get(context.state.studentProfile.images.likeness).then(function (response) {
                context.commit('GET_STUDENT_LIKENESS', response);
            }).catch(function (error) {
                context.commit("API_FAILURE", error);
            });
            window.axios.get(context.state.studentProfile.images.avatar).then(function (response) {
